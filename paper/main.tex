...
%     into 5-day bins to smooth; the daily and 10-day-bin versions are also
%     produced by a_sdid_figures_pa_vs_na.do). ---
\begin{figure}[htb!]
    \caption{Synthetic difference-in-differences, observed vs.\ synthetic-control trajectory (apex scandals, violent protests; 5-day bins): $\pm 30$-day window.}
    \label{fig:sdid_trends30}
    \begin{center}\includegraphics[width=0.72\textwidth]{sdid_trends_apex_violent_w30_b5.pdf}\end{center}
    \footnotesize{Average across the 63 apex scandals of the daily violent-protest count (pooled into 5-day bins) in the treated country (observed) and in its synthetic control, in event time. Synthetic difference-in-differences identifies off the \emph{change} in the treated-minus-synthetic gap, so the synthetic need not match the treated's pre-scandal level---apex countries protest more at baseline, so the synthetic as estimated (dashed) sits below; the dotted line shifts it up by its pre-scandal offset (the difference-in-differences intercept) to align the pre-period, so the post-disclosure divergence is the estimated effect. Vertical line marks the disclosure date. Sample period 2008--2018; Venezuela excluded.}
\end{figure}

\begin{figure}[htb!]
    \caption{Observed vs.\ synthetic-control trajectory (apex, violent; 5-day bins): $\pm 60$-day window. Construction as in \autoref{fig:sdid_trends30}.}
    \label{fig:sdid_trends60}
    \begin{center}\includegraphics[width=0.72\textwidth]{sdid_trends_apex_violent_w60_b5.pdf}\end{center}
\end{figure}

\begin{figure}[htb!]
    \caption{Observed vs.\ synthetic-control trajectory (apex, violent; 5-day bins): $\pm 90$-day window. Construction as in \autoref{fig:sdid_trends30}.}
    \label{fig:sdid_trends90}
    \begin{center}\includegraphics[width=0.72\textwidth]{sdid_trends_apex_violent_w90_b5.pdf}\end{center}
\end{figure}

\begin{figure}[htb!]
    \caption{Synthetic difference-in-differences, in-space placebo test (apex scandals, violent protests; 5-day bins): $\pm 30$-day window.}
    \label{fig:sdid_placebo30}
    \begin{center}\includegraphics[width=0.72\textwidth]{sdid_placebo_apex_violent_w30_b5.pdf}\end{center}
    \footnotesize{Permutation (in-space placebo) test. For every apex scandal we additionally treat each donor country as a placebo-treated unit, rebuilding its synthetic control from the remaining donors. Each gray line is one donor country's average placebo gap---treated minus synthetic, demeaned by its own pre-scandal average and pooled into 5-day bins---across the scandals in which it serves as a donor; the red line is the true apex gap and the black horizontal line marks a zero gap. The apex gap rises to the upper edge of the placebo distribution just after disclosure and returns toward the cloud thereafter, consistent with a sharp, transitory response. Sample period 2008--2018; Venezuela excluded.}
\end{figure}

\begin{figure}[htb!]
    \caption{In-space placebo test (apex, violent; 5-day bins): $\pm 60$-day window. Construction as in \autoref{fig:sdid_placebo30}.}
    \label{fig:sdid_placebo60}
    \begin{center}\includegraphics[width=0.72\textwidth]{sdid_placebo_apex_violent_w60_b5.pdf}\end{center}
\end{figure}

\begin{figure}[htb!]
    \caption{In-space placebo test (apex, violent; 5-day bins): $\pm 90$-day window. Construction as in \autoref{fig:sdid_placebo30}.}
    \label{fig:sdid_placebo90}
    \begin{center}\includegraphics[width=0.72\textwidth]{sdid_placebo_apex_violent_w90_b5.pdf}\end{center}
\end{figure}
