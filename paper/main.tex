...
% --- SDID diagnostics: observed vs. synthetic (trends) and the in-space
%     placebo permutation, at the +-30/60/90-day windows (daily counts pooled
%     into 15-day bins to smooth, matching the main-text event studies; the
%     daily, 5- and 10-day-bin versions are also produced by
%     a_sdid_figures_pa_vs_na.do). ---
\begin{figure}[htb!]
    \caption{Synthetic difference-in-differences: observed vs.\ synthetic-control trajectory (apex scandals, violent protests; 15-day bins).}
    \label{fig:sdid_trends}
    \begin{center}
    \begin{subfigure}{0.49\textwidth}\caption{$\pm 30$-day window.}
        \includegraphics[width=\textwidth]{sdid_trends_apex_violent_w30_b15.pdf}\end{subfigure}\hfill
    \begin{subfigure}{0.49\textwidth}\caption{$\pm 60$-day window.}
        \includegraphics[width=\textwidth]{sdid_trends_apex_violent_w60_b15.pdf}\end{subfigure}

    \begin{subfigure}{0.49\textwidth}\caption{$\pm 90$-day window.}
        \includegraphics[width=\textwidth]{sdid_trends_apex_violent_w90_b15.pdf}\end{subfigure}
    \end{center}
    \footnotesize{Average across the 63 apex scandals of the daily violent-protest count---pooled into 15-day bins, matching the main-text event studies---in the treated country (observed) and in its synthetic control, in event time. Synthetic difference-in-differences identifies off the \emph{change} in the treated-minus-synthetic gap, so the synthetic need not match the treated's pre-scandal level; apex countries protest more at baseline, so the synthetic as estimated (dashed) sits below, and the dotted line shifts it up by its pre-scandal offset (the difference-in-differences intercept) to align the pre-period, so the post-disclosure divergence is the estimated effect. The synthetic control is a weighted average over the (roughly 18) donor countries and is then averaged across scandals, so each point pools far more country-days than the observed line and is correspondingly smoother. Vertical lines mark the disclosure date. Sample period 2008--2018; Venezuela excluded.}
\end{figure}

\begin{figure}[htb!]
    \caption{Synthetic difference-in-differences: in-space placebo test (apex scandals, violent protests; 15-day bins).}
    \label{fig:sdid_placebo}
    \begin{center}
    \begin{subfigure}{0.49\textwidth}\caption{$\pm 30$-day window.}
        \includegraphics[width=\textwidth]{sdid_placebo_apex_violent_w30_b15.pdf}\end{subfigure}\hfill
    \begin{subfigure}{0.49\textwidth}\caption{$\pm 60$-day window.}
        \includegraphics[width=\textwidth]{sdid_placebo_apex_violent_w60_b15.pdf}\end{subfigure}

    \begin{subfigure}{0.49\textwidth}\caption{$\pm 90$-day window.}
        \includegraphics[width=\textwidth]{sdid_placebo_apex_violent_w90_b15.pdf}\end{subfigure}
    \end{center}
    \footnotesize{Permutation (in-space placebo) test. For every apex scandal we additionally treat each donor country as a placebo-treated unit, rebuilding its synthetic control from the remaining donors. Each gray line is one donor country's average placebo gap---treated minus synthetic, demeaned by its own pre-scandal average and pooled into 15-day bins---across the scandals in which it serves as a donor; the red line is the true apex gap and the black horizontal line marks a zero gap. The apex gap rises to the upper edge of the placebo distribution just after disclosure and returns toward the cloud thereafter, consistent with a sharp, transitory response. Sample period 2008--2018; Venezuela excluded.}
\end{figure}
