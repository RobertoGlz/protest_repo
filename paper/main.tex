...
\begin{figure}[htb!]
    \caption{Synthetic difference-in-differences: observed vs.\ synthetic-control trajectory (apex scandals, violent protests, $\pm 90$-day window).}
    \label{fig:sdid_trends}
    \begin{center}
        \includegraphics[width=0.82\textwidth]{sdid_trends_apex_violent.pdf}
    \end{center}
    \footnotesize{Average across the 63 apex scandals of the daily violent-protest count in the treated country (observed) and in its synthetic control, in event time. Synthetic difference-in-differences identifies off the \emph{change} in the treated-minus-synthetic gap, so the synthetic need not match the treated's pre-scandal level---apex countries protest more at baseline, so the synthetic control as estimated (dashed) sits below. The dotted line shifts that synthetic up by its pre-scandal offset (the difference-in-differences intercept), aligning it to the observed series before disclosure so that the post-disclosure divergence is the estimated effect. Vertical line marks the disclosure date. Sample period 2008--2018; Venezuela excluded.}
\end{figure}

\begin{figure}[htb!]
    \caption{Synthetic difference-in-differences: in-space placebo test (apex scandals, violent protests, $\pm 90$-day window).}
    \label{fig:sdid_placebo}
    \begin{center}
        \includegraphics[width=0.82\textwidth]{sdid_placebo_apex_violent.pdf}
    \end{center}
    \footnotesize{Permutation (in-space placebo) test. For every apex scandal we additionally treat each donor country as a placebo-treated unit, rebuilding its synthetic control from the remaining donors. Each gray line is one donor country's average placebo gap---treated minus synthetic, demeaned by its own pre-scandal average---across the scandals in which it serves as a donor; the red line is the true apex gap. The apex gap rises to the upper edge of the placebo distribution in the days immediately after disclosure and returns toward the placebo cloud thereafter, consistent with a sharp, transitory response. Sample period 2008--2018; Venezuela excluded.}
\end{figure}
