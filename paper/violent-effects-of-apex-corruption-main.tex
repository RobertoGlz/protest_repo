...
\autoref{tab:sup_democracy_lmh} sharpens the comparison by grouping countries into terciles of the 2008 Electoral Democracy Index and pooling the top two (``Medium+High'') against the bottom tercile (``Low''). The violent-protest effect is larger in the Medium+High group at every window and the one-sided ordering $\beta_{\text{Medium+High}}>\beta_{\text{Low}}$ strengthens at the wider windows---so, to the extent the heterogeneity is real, it is the \emph{higher}-democracy countries that drive the effect.
