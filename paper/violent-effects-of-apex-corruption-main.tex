...
The grievance-split randomization-inference histograms (one per grievance outcome, Apex/Non-Apex $\times$ $\pm30/60/90$) are produced by \texttt{g\_randomization\_inference.do}; they are included below.
