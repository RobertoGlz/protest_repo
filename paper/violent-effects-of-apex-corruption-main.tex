...
As a descriptive complement to the cross-sectional democracy split, \autoref{fig:sup_dem_scandals} tracks apex-scandal accumulation and the level of democracy over time. The countries in which our scandals occur are split into the bottom and top tercile of the 2008 V-Dem Electoral Democracy Index (the same 2008 tercile classification used in the paper's democracy tables). Each solid line (left axis) is one country's running count of apex scandals since 2008; the two short-dashed lines (right axis) are the bottom- and top-tercile mean Electoral Democracy Index. Individual countries accumulate apex scandals steeply after 2014 (most dramatically Peru, then Brazil and Guatemala), while both tercile-mean democracy indices stay flat until about 2016 and then decline---so scandal accumulation \emph{precedes} the democracy dip. This is descriptive, not a causal estimate.

\begin{figure}[htb!]
    \caption{Apex scandals and the Electoral Democracy Index over time, by 2008 democracy tercile.}
    \label{fig:sup_dem_scandals}
    \begin{center}
    \includegraphics[width=0.9\textwidth]{democracy_scandals_timeseries.pdf}
    \end{center}
    \footnotesize{The scandal countries are split into the bottom (6 countries) and top (5 countries) tercile of the 2008 V-Dem Electoral Democracy Index (\texttt{v2x\_polyarchy}), by \texttt{xtile}, \texttt{nq(3)}---the same classification used in the paper's democracy heterogeneity tables; the middle tercile is omitted. Each solid line (left axis) is one country's cumulative count of apex-corruption scandals since 2008, labelled at its 2019 endpoint (bottom-tercile countries in cranberry, top-tercile in navy). The two short-dashed lines (right axis) are the bottom- and top-tercile mean Electoral Democracy Index. Individual countries accumulate scandals steeply after 2014 (Peru most, then Brazil and Guatemala), while both tercile-mean indices are flat until about 2016 and then fall (top tercile from about 0.85 to 0.81, bottom tercile from about 0.55 to 0.50), so scandal accumulation precedes the democracy decline. Descriptive only. Sample period 2008--2019; Venezuela excluded.}
\end{figure}
