...
% \autoref to an appendix section should read "Supplementary Materials S#"
% (redefined here, after hyperref's \AtBeginDocument setup, so it is not
%  overwritten). Only section-level names are changed; Table/Figure are intact.
