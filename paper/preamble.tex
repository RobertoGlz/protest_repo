...
\newcommand{\td}{\todoLink}
\newcommand{\forSJ}[1]{\td[color=green!20,inline,caption={\thetodoListItems:
    For @Saum}]{\textbf{@Saum} -- #1}}
...
\newcommand{\forLR}[1]{\td[color=yellow!20,inline,caption={\thetodoListItems:
    For @Lalo}]{\textbf{@Lalo} -- #1}}
