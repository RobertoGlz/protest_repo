...
esttab m1 m2 m3 using "${tables}/Protests/Summary/depreciations_as_random.tex", b(3) se(3) stats(aux r2 r2_a aux2 aux3 cyfe dayw month daym close, labels("Mean dep. var" "R-squared" "R-squared adj." "Accuracy" "F-test" "Country x Year FE" "Day of week" "Month" "Day of the Month" "Close to Election")) star(* 0.10 ** 0.05 *** 0.01) substitute("\_" "_") keep(_cons) drop(_cons) noobs nonotes booktabs replace ///
mtitles("1(Depreciation)" "1(Depreciation)" "1(Depreciation)")
...
esttab m1 m2 m3 m4 using "${tables}/Protests/Summary/depreciations_as_random_outsample.tex", ///
	...
	mtitles("1(Depreciation)" "1(Depreciation)" "1(Depreciation)" "1(Depreciation)")