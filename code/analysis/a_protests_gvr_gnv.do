...
panelcombine, use(Panel1.tex Panel2.tex Panel3.tex) columncount(6) ///
	paneltitles("Corruption Scandals" "Depreciation (Month-on-Month)" "Loss of Football Matches") ///
		save("${tables}/Protests/Regressions/panels_corruption_depreciation_football.tex") cleanup
...
foreach outcome of varlist num_violent_MM num_peaceful_MM government_response_violent {
	...
	graph export "${graphs}/Protests/`outcome'_corruption_cyfe_8m.pdf", replace
}
/* Loop for estimation using scandal FE */
foreach outcome of varlist num_violent_MM num_peaceful_MM government_response_violent {
	...
	graph export "${graphs}/Protests/`outcome'_corruption_scandalfe_8m.pdf", replace
}
...
foreach outcome of varlist num_violent_MM num_peaceful_MM government_response_violent {
	...
	graph export "${graphs}/Protests/`outcome'_depreciation_cyfe_8m.pdf", replace
}
/* Loop for estimation using scandal FE */
foreach outcome of varlist num_violent_MM num_peaceful_MM government_response_violent {
	reghdfe `outcome' ${leads} ${lags} i.month i.month i.day if inrange(window, -120, 120), absorb(${scandal_fe}) vce(${cydays})
	...
	graph export "${graphs}/Protests/`outcome'_depreciation_scandalfe_8m.pdf", replace
}
...
foreach outcome of varlist num_violent_MM num_peaceful_MM government_response_violent {
	...
	graph export "${graphs}/Protests/`outcome'_football_cyfe_8m.pdf", replace
}
/* Loop for estimation using scandal FE */
foreach outcome of varlist num_violent_MM num_peaceful_MM government_response_violent {
	reghdfe `outcome' ${leads} ${lags} i.month i.month i.day if inrange(window, -120, 120), absorb(${scandal_fe}) vce(${cydays})
	...
	graph export "${graphs}/Protests/`outcome'_football_scandalfe_8m.pdf", replace
}
