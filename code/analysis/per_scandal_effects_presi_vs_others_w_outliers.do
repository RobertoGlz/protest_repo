...
foreach outcome of local outcome_list {
	...
	graph export ///
		"${figout}/per_scandal_box_`outcome'_w`window_length'_presi_w_outliers.pdf", replace
}

display in green "per_scandal_effects_presi_vs_others_w_outliers.do finished OK"
