...
/* Read in dataset */
use "${datfin}/protests_scandals_120days_mild", clear
drop if (country == "Venezuela")

/* keep mild scandals */
keep if (importance == 3)
...
graph export "${work}/results/figures/es_mild_numviolentMM_90d_after2010_overlaps_90ci.png", replace
...
graphregion(fcolor(white) lcolor(white) lwidth(vvvthin) ifcolor(white) ilcolor(white)  ///
ilwidth(vvvthin)) ciopts(lwidth(*1.5) lcolor(black)) mcolor(black) scheme(plotplain)
graph export "${work}/results/figures/es_mild_gvtviolent_90d_after2010_overlaps_90ci.png", replace
...
graphregion(fcolor(white) lcolor(white) lwidth(vvvthin) ifcolor(white) ilcolor(white)  ///
ilwidth(vvvthin)) ciopts(lwidth(*1.5) lcolor(black)) mcolor(black) scheme(plotplain)
graph export "${work}/results/figures/es_mild_gvtnonviolent_90d_after2010_overlaps_90ci.png", replace
...
graphregion(fcolor(white) lcolor(white) lwidth(vvvthin) ifcolor(white) ilcolor(white)  ///
ilwidth(vvvthin)) ciopts(lwidth(*1.5) lcolor(black)) mcolor(black) scheme(plotplain)
graph export "${work}/results/figures/es_mild_numviolentMM_90d_after2010_nooverlaps_90ci.png", replace
...
graphregion(fcolor(white) lcolor(white) lwidth(vvvthin) ifcolor(white) ilcolor(white)  ///
ilwidth(vvvthin)) ciopts(lwidth(*1.5) lcolor(black)) mcolor(black) scheme(plotplain)
graph export "${work}/results/figures/es_mild_gvtviolent_90d_after2010_nooverlaps_90ci.png", replace
...
graphregion(fcolor(white) lcolor(white) lwidth(vvvthin) ifcolor(white) ilcolor(white)  ///
ilwidth(vvvthin)) ciopts(lwidth(*1.5) lcolor(black)) mcolor(black) scheme(plotplain)
graph export "${work}/results/figures/es_mild_gvtnonviolent_90d_after2010_nooverlaps_90ci.png", replace
...
graphregion(fcolor(white) lcolor(white) lwidth(vvvthin) ifcolor(white) ilcolor(white)  ///
ilwidth(vvvthin)) ciopts(lwidth(*1.5) lcolor(black)) mcolor(black) scheme(plotplain)
graph export "${work}/results/figures/es_mild_numviolentMM_90d_after2010_overlaps_90ci_scandalfe.png", replace
...
graphregion(fcolor(white) lcolor(white) lwidth(vvvthin) ifcolor(white) ilcolor(white)  ///
ilwidth(vvvthin)) ciopts(lwidth(*1.5) lcolor(black)) mcolor(black) scheme(plotplain)
graph export "${work}/results/figures/es_mild_gvtviolent_90d_after2010_overlaps_90ci_scandalfe.png", replace
...
graphregion(fcolor(white) lcolor(white) lwidth(vvvthin) ifcolor(white) ilcolor(white)  ///
ilwidth(vvvthin)) ciopts(lwidth(*1.5) lcolor(black)) mcolor(black) scheme(plotplain)
graph export "${work}/results/figures/es_mild_gvtnonviolent_90d_after2010_overlaps_90ci_scandalfe.png", replace
...
graphregion(fcolor(white) lcolor(white) lwidth(vvvthin) ifcolor(white) ilcolor(white)  ///
ilwidth(vvvthin)) ciopts(lwidth(*1.5) lcolor(black)) mcolor(black) scheme(plotplain)
graph export "${work}/results/figures/es_mild_numviolentMM_90d_after2010_nooverlaps_90ci_scandalfe.png", replace
...
graphregion(fcolor(white) lcolor(white) lwidth(vvvthin) ifcolor(white) ilcolor(white)  ///
ilwidth(vvvthin)) ciopts(lwidth(*1.5) lcolor(black)) mcolor(black) scheme(plotplain)
graph export "${work}/results/figures/es_mild_gvtviolent_90d_after2010_nooverlaps_90ci_scandalfe.png", replace
...
graphregion(fcolor(white) lcolor(white) lwidth(vvvthin) ifcolor(white) ilcolor(white)  ///
ilwidth(vvvthin)) ciopts(lwidth(*1.5) lcolor(black)) mcolor(black) scheme(plotplain)
graph export "${work}/results/figures/es_mild_gvtnonviolent_90d_after2010_nooverlaps_90ci_scandalfe.png", replace
...
graphregion(fcolor(white) lcolor(white) lwidth(vvvthin) ifcolor(white) ilcolor(white)  ///
ilwidth(vvvthin)) ciopts(lwidth(*1.5) lcolor(black)) mcolor(black) scheme(plotplain)
graph export "${work}/results/figures/es_mild_numviolentMM_120d_after2010_overlaps_90ci.png", replace
...
graphregion(fcolor(white) lcolor(white) lwidth(vvvthin) ifcolor(white) ilcolor(white)  ///
ilwidth(vvvthin)) ciopts(lwidth(*1.5) lcolor(black)) mcolor(black) scheme(plotplain)
graph export "${work}/results/figures/es_mild_gvtviolent_120d_after2010_overlaps_90ci.png", replace
...
graphregion(fcolor(white) lcolor(white) lwidth(vvvthin) ifcolor(white) ilcolor(white)  ///
ilwidth(vvvthin)) ciopts(lwidth(*1.5) lcolor(black)) mcolor(black) scheme(plotplain)
graph export "${work}/results/figures/es_mild_gvtnonviolent_120d_after2010_overlaps_90ci.png", replace
...
graphregion(fcolor(white) lcolor(white) lwidth(vvvthin) ifcolor(white) ilcolor(white)  ///
ilwidth(vvvthin)) ciopts(lwidth(*1.5) lcolor(black)) mcolor(black) scheme(plotplain)
graph export "${work}/results/figures/es_mild_numviolentMM_120d_after2010_nooverlaps_90ci.png", replace
...
graphregion(fcolor(white) lcolor(white) lwidth(vvvthin) ifcolor(white) ilcolor(white)  ///
ilwidth(vvvthin)) ciopts(lwidth(*1.5) lcolor(black)) mcolor(black) scheme(plotplain)
graph export "${work}/results/figures/es_mild_gvtviolent_120d_after2010_nooverlaps_90ci.png", replace
...
graphregion(fcolor(white) lcolor(white) lwidth(vvvthin) ifcolor(white) ilcolor(white)  ///
ilwidth(vvvthin)) ciopts(lwidth(*1.5) lcolor(black)) mcolor(black) scheme(plotplain)
graph export "${work}/results/figures/es_mild_gvtnonviolent_120d_after2010_nooverlaps_90ci.png", replace
...
graphregion(fcolor(white) lcolor(white) lwidth(vvvthin) ifcolor(white) ilcolor(white)  ///
ilwidth(vvvthin)) ciopts(lwidth(*1.5) lcolor(black)) mcolor(black) scheme(plotplain)
graph export "${work}/results/figures/es_mild_numviolentMM_120d_after2010_overlaps_90ci_scandalfe.png", replace
...
graphregion(fcolor(white) lcolor(white) lwidth(vvvthin) ifcolor(white) ilcolor(white)  ///
ilwidth(vvvthin)) ciopts(lwidth(*1.5) lcolor(black)) mcolor(black) scheme(plotplain)
graph export "${work}/results/figures/es_mild_gvtviolent_120d_after2010_overlaps_90ci_scandalfe.png", replace
...
graphregion(fcolor(white) lcolor(white) lwidth(vvvthin) ifcolor(white) ilcolor(white)  ///
ilwidth(vvvthin)) ciopts(lwidth(*1.5) lcolor(black)) mcolor(black) scheme(plotplain)
graph export "${work}/results/figures/es_mild_gvtnonviolent_120d_after2010_overlaps_90ci_scandalfe.png", replace
...
graphregion(fcolor(white) lcolor(white) lwidth(vvvthin) ifcolor(white) ilcolor(white)  ///
ilwidth(vvvthin)) ciopts(lwidth(*1.5) lcolor(black)) mcolor(black) scheme(plotplain)
graph export "${work}/results/figures/es_mild_numviolentMM_120d_after2010_nooverlaps_90ci_scandalfe.png", replace
...
graphregion(fcolor(white) lcolor(white) lwidth(vvvthin) ifcolor(white) ilcolor(white)  ///
ilwidth(vvvthin)) ciopts(lwidth(*1.5) lcolor(black)) mcolor(black) scheme(plotplain)
graph export "${work}/results/figures/es_mild_gvtviolent_120d_after2010_nooverlaps_90ci_scandalfe.png", replace
/* Estimate regression for Gvt Nonviolent Responses */
...
graphregion(fcolor(white) lcolor(white) lwidth(vvvthin) ifcolor(white) ilcolor(white)  ///
ilwidth(vvvthin)) ciopts(lwidth(*1.5) lcolor(black)) mcolor(black) scheme(plotplain)
graph export "${work}/results/figures/es_mild_gvtnonviolent_120d_after2010_nooverlaps_90ci_scandalfe.png", replace
...
panelcombine, use(Panel1.tex Panel2.tex Panel3.tex) columncount(8) ///
	...
	save("${work}/results/tables/protests_gvtresp_alt_specs_mildscandals.tex") cleanup