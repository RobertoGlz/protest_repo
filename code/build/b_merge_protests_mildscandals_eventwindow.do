...
/* Creating 30-day period lags of the indicator variable of scandals */
...
generate post1 = (window >= 0 & window <= 60)
generate post2 = (window >= 61 & window <= 120)

/* Creating 30-day period leads of the indicator variable of scandals */
...
/* Keep only mild scandals */
keep if (importance == 3)

/* Save clean and merged dataset */
save "${datfin}/protests_scandals_120days_mild.dta", replace
