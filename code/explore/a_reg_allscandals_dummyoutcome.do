...
foreach outcome in "dum_protests_MM" "dum_violent_MM" "dum_peaceful_MM" "dum_gvt_violent" {
	...
	graph export "${work}/results/figures/es_dummy_outcome_allscandals_`outcome'_`window_days'd_`cilevel'ci.png", replace

}

esttab _all using "${work}/results/tables/es_dummyoutcome_allscandals_`window_days'd_`cilevel'ci.tex", ///
