...
generate inc_gov = .
replace inc_gov = 1 if (position == "governor" & political_affiliation == "incumbent")
replace inc_gov = 0 if (position != "governor" & position != "president")
tabulate inc_gov position
...
panelcombine, use(Panel1.tex Panel0.tex) ///
	columncount(3) paneltitles("Incumbent Governors" "Others excl. Presidents") ///
