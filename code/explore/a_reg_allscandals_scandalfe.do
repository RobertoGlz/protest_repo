...
foreach outcome in "num_protests_MM" "num_violent_MM" "num_peaceful_MM" "government_response_violent" {
	...
	graph export "${work}/results/figures/es_`outcome'_`window_days'd_`cilevel'ci_scandalfe.png", replace

}

esttab _all using "${work}/results/tables/es_`window_days'd_`cilevel'ci_scandalfe.tex", ///
