...
foreach outcome in "num_protests_MM" "num_violent_MM" "num_peaceful_MM" "government_response_violent" {
	...
	graph export "${work}/results/figures/es_dummy_outcome_`outcome'_120d_LBscandals_90ci.png", replace
}

esttab _all using "${work}/results/tables/es_dummyoutcome_120d_LBscandals_`cilevel'ci.tex", ///
	...
	"\shortstack{Gvt. Violent\\Response > 0}") stats(N num_scandals r2 cy_fe serr, ///
